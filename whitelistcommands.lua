...
local whitelist = loadstring(game:HttpGet("https://github.com/Sail100/whitelist/blob/main/idwhitelist.lua"))()
local FunctionsLibrary = loadstring(game:HttpGet("https://github.com/Sail100/BedWarsCode/blob/main/Libraries/FunctionsHandler.lua"))()
